...
import {
  ...
  productCoverageGap,
  requiredCellsFor,
} from "@/features/admin/works/domain/track-coverage";

console.log(
  "▶ src/features/admin/works/domain/track-coverage.ts — cases attendues d'une œuvre et couverture d'une offre",
);

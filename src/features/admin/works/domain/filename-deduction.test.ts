...
import {
  ...
  readFilename,
  type MatrixContext,
} from "@/features/admin/works/domain/filename-deduction";

console.log(
  "▶ src/features/admin/works/domain/filename-deduction.ts — déduction du placement d'un fichier depuis son nom",
);

...
} from "@/features/admin/works/server/sellability/activation-plan";

console.log(
  "▶ src/features/admin/works/server/sellability/activation-plan.ts — quelles offres activer, d'après les pistes présentes",
);

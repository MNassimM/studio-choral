...
import { cartItemToGrant, containsSku } from "@/features/cart/domain/cart-item";
import {
  clearCart,
  findCoveredItems,
  removeFromCart,
...
import { parseCart, serializeCart } from "@/features/cart/domain/serialization";
import {
  CART_STORAGE_KEY,
  clearStoredCart,
  readStoredCart,
  writeStoredCart,
} from "@/features/cart/client/storage";
 ...
 *
 * Le fournisseur orchestre, toutes les règles vivant dans features/cart/domain.
 *

/**
 * Types du domaine des droits d'accès (src/domain/access). Unions de chaînes
 ...
 * dates de création/révocation...) : domain/access ne calcule qu'à partir de
 * droits déjà considérés actifs (voir src/features/catalog, qui filtre
 ...
 * de resolveWorkAccess() (src/domain/access/work-access.ts), destiné à traverser la

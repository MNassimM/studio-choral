...
import { dedupeGrants } from "@/domain/access/grant-dedupe";
...
import {
  ...
  capabilitiesFor,
  resolveWorkAccess,
} from "@/domain/access/work-access";
import type { Grant, WorkAccessInput } from "@/domain/types";

console.log(
  "▶ src/domain/access/work-access.ts — résolution des droits, capacités par piste et absorption",
);
